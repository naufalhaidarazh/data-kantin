                ...
                <div class="col-10 tabel-makan">
                    <div class="container-fluid">
                        <div class="container judul text-center my-4">
                            ...
                            <p>Daftar Harga Makanan Di Kantin Bu Sri</p>
                            <div class="tabel">
                                <table class="table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th class="list-edit">Nama Makanan</th>
                                            <th class="list-edit">Deskripsi Makanan</th>
                                    ...
                                    <?php
                                        ...
                                        while($data = mysqli_fetch_array($makanan)){
                                            echo("
                                                <tr>
                                                    <td>$no</td>
                                                    <td class='list-edit'>$data[nama_makanan]</td>
                                                    <td class='list-edit'>$data[deskripsi]</td>
                                                    <td>$data[sisa_produk]</td>
                                                    <td>$data[harga]</td>
                                                    <td class='text-decoration-none'>
                                                    <a href='editmakanan.php?id=$data[id_makanan]' class='me-3'>
                                                        <img src='../style/edit.svg' alt='' width='25'>
                                                    </a>
                                                    <a href='aksihapusmakanan.php?id=$data[id_makanan]'>
                            ...
                            <button class="btn btn-primary mt-4 px-4 py-2 shadow"><a href="tambahmakanan.php" class="text-decoration-none text-light">Tambahkan Daftar Makanan</a></button>
