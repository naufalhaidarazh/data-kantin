                        ...
                        <div class="container judul">
                            <div class="row mt-4">
                                <div class="col-1 mt-2">
                                    <a href="minuman.php"><img src="../style/back.svg" alt="" width="35"></a>
                                </div>
                                <div class="col-11">
                                    <p class="text-center">Tambah Daftar Minuman Di Kantin Bu Sri</p>
                                </div>
                            </div>
                            
                            
                            <form action="aksitambahminuman.php" method="post">
                                <div class="mb-4">
                                    <label for="" class="form-label"><a>Nama Minuman</a></label>
                                    <input type="text" name="nama_minuman" class="form-control" placeholder="masukan nama minuman">
                                </div>
                                <div class="mb-4">
                                    <label for="" class="form-label"><a>Deskripsi Minuman</a></label>
                                    <input type="text" name="deskripsi" class="form-control" placeholder="masukkan deskripsi minuman">
                                </div>
                                <div class="mb-4">
                                    <label for="" class="form-label"><a>Sisa Produk Minuman</a></label>
                                    <input type="text" name="sisa_produk" class="form-control" placeholder="masukkan sisa produk minuman">
                                </div>
                                <div class="mb-4">
                                    <label for="" class="form-label"><a>Harga Minuman</a></label>
                                    <input type="text" name="harga" class="form-control" placeholder="masukkan harga produk minuman">
                                </div>
